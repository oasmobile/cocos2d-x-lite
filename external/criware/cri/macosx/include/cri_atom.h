...
/* バージョン情報 */
/* Version Number */
#define CRI_ATOM_VERSION				(0x02143500)
#define CRI_ATOM_VER_NUM				"2.14.35"
 ...
 */
#define CRIATOMAWB_WORKSIZE_FOR_LOADFROMMEMORY	(8 * sizeof(CriUintPtr))
 ...
 * <br>
 * デクリプタ作成後にプレーヤを作成した場合は、
 * プレーヤを破棄するまでデクリプタを破棄しないでください。<br>
 * プレーヤを残した状態でデクリプタを破棄した場合、
