 ...
 * ::criAtomEx_RegisterAcfConfig 関数実行前でも本関数は実行可能です。<br>
 ...
 * 現在、プレーヤにアタッチできるトゥイーンの最大数は、8個固定です。
 * \sa criAtomExPlayer_DetachTween, criAtomExPlayer_DetachTweenAll, criAtomExTween_Create
 */
